...
Ruby API wrapper for [Crunchbase API doc][v2doc].

If you are using Crunchbase Version 3.0 API, Please use [crunchbase-ruby-library][v3gem]

[v2doc]: https://developer.crunchbase.com/docs
[v3gem]: https://github.com/encoreshao/crunchbase-ruby-library
