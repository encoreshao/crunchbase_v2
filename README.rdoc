...
Ruby API wrapper for [Crunchbase API doc](https://developer.crunchbase.com/docs).

If you are using Crunchbase Version 3.0 API, Please use [crunchbase-ruby-library](https://github.com/encoreshao/crunchbase-ruby-library)
